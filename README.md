...
- Real-time доставка через Phoenix PubSub и Presence для гостей.
- Стабильная гостевая идентичность в подписанной браузерной сессии.
- История сообщений с курсорной пагинацией.
- Один экземпляр приложения и один PostgreSQL.

Поле приватности уже закрыто на уровне доменного контекста: гости не получают
приватные каналы. Полноценный доступ к ним появится вместе с пользователями и
членством в каналах.
...
1. Пользователи, вход, рабочие пространства, роли и членство в каналах.
